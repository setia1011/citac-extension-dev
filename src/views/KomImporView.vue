<template>
   <div ref="main" id="main" class="container is-fluid mt-5 p-32">
         ...
         <div class="is-pulled-right">
            <button class="button is-small box is-info is-outlined mb-4" data-show="quickview" data-target="quickviewDefault">
               <span class="icon">
         ...
         <!-- <div class="columns" v-if="s_kantor === '010700,050100,040300,060100,070100'">
            <div class="column">{{ s_kantorx }}</div>
         </div> -->
         ...
         <div class="icon-text mb-5">
            ...
            <span class="title is-size-5">Tren Komoditi Impor <span class="has-text-info-dark">({{ s_tahun }})</span></span>
         </div>
         ...
         <div class="columns is-multiline is-variable is-1-mobile is-1-tablet is-1-desktop is-1-widescreen is-1-fullhd mt-1">
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="this.c_netto.series?.length > 0" 
                     :key="c_netto?.series"
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_total_bayar_per_netto.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_avg_bayar_per_netto.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_avg_bm_per_netto.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_teus_bulanan.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_total_bayar_per_teus.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_avg_bayar_per_teus.series?.length > 0" 
            ...
            <div class="column is-full-mobile is-full-tablet is-half-desktop is-one-third-widescreen pb-1 pt-1">
               ...
               <div class="is-relative">
                  ...
                  <v-chart 
                     v-if="c_avg_bm_per_teus.series?.length > 0" 
...
export default {
   ...
   data() {
      return {
         ...
         s_kantorx: [
            ...
            {
               nama_kantor: "KPU BEA DAN CUKAI TIPE A TANJUNG PRIOK", 
               kd_kantor: '040300'
            },
            {
               nama_kantor: "KPU BEA DAN CUKAI TIPE C SOEKARNO-HATTA", 
               kd_kantor: '050100'
            },
            {
   ...
   methods: {
      toXLSX: function(items, filename) {
         var wb = XLSX.utils.book_new();
         for (var i = 0; i < items.length; i++) {
            var ws = XLSX.utils.json_to_sheet(items[i].data, { skipHeader: 1 });
            XLSX.utils.book_append_sheet(wb, ws, items[i].name);
         }
      ...
      teusBulanan: function() {
         ...
         if (!this.s_kantor) 
            return; 
         ciaxios.get("chart/teus_bulanan", {
            params: {
      ...
      impor: function() {
         ...
         ciaxios.get("chart/impor", {
            ...
            setTimeout(() => {
               this.isLoading = false;
               const xAxisData = res.data.netto.map(e => (
                  e.data.map(e => [null,'Jan', 'Feb', 'Mar', 'Apr','Mei','Jun','Jul','Aug','Sep','Okt','Nov','Dec'][e[0]])
               ));
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              onclick: async () => {
                                 await this.toXLSX(this.c_netto.series, 'netto');
                              }
                        },
                     ...
                     formatter: function (params) {
                        ...
                        for (var i=0; i<params.length; i++) {
                           f += `${params[i].marker} ${params[i].seriesName} &nbsp;&nbsp; `+
                              `<span class='is-pulled-right'><b>` + new Intl.NumberFormat('id').format(params[i].value[1] ? params[i].value[1].toFixed(2) : 0) + `</b></span><br/>`;
                        }
                        return f;
                     }
                  },
               ...
               if (res.data.netto.length > 1) {
                  this.c_netto.legend.formatter = (name) => {
                     return this.s_kantorx.filter(row => row.nama_kantor === name)[0].kd_kantor;
                  }
                  this.c_netto.legend.tooltip = { show: true }
                  // this.c_netto.legend.top = 0;
                  // this.c_netto.legend.right = 0;
                  // this.c_netto.legend.width = "200";
               } else {
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_avg_bayar_per_netto.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_avg_bayar_per_teus.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_avg_bm_per_netto.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_teus_bulanan.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_avg_bm_per_teus.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_total_bayar_per_netto.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
                  ...
                  toolbox: {
                     ...
                     feature: {
                        ...
                        myTool1: {
                              ...
                              icon: 'path fill="none" stroke="currentColor" d="M2.5 3.5v-2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-10a1 1 0 0 1-1-1v-2m0-6l4 4m-4 0l4-4m-5-2h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"',
                              onclick: async () => {
                                 await this.toXLSX(this.c_total_bayar_per_teus.series, 'netto');
                              }
                        },
                        saveAsImage: { show: true }
                     }
      ...
      imporTop: function() {
         var number = 25;
         ciaxios.get(`chart/impor/top/${number}`, {
            params: {
               kd_kantor: this.s_kantor,
               from: this.from,
               to: this.to
      ...
      imporSummary: function() {
         var number = 25;
         ciaxios.get(`chart/impor/summary/${number}`, {
            params: {
               from: this.from,
               to: this.to
            }
