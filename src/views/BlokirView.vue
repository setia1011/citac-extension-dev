<template>
   <div ref="main" id="main" class="container is-fluid mt-5 p-32">
      ...
      <div class="is-pulled-right">
         ...
         <button :disabled="data_blokir.length === 0" class="button is-small is-black box is-inline-block mr-1" v-on:click="toXLSX()">
            <span class="icon">
               <i class="fa-thin fa-file-spreadsheet"></i>
            </span>
            <!-- <span>Download</span> -->
         ...
         <button class="button is-small is-danger is-outlined box is-inline-block mr-1" v-on:click="refresh($event)">
            <span class="icon">
      ...
      <div class="icon-text mb-5">
         ...
         <span class="title is-size-5">Cek Blokir</span>
      </div>
               ...
               <table class="table is-striped is-narrow is-hoverable is-fullwidth">
                  <thead>
                     <tr>
                        ...
                        <th class="is-hidden-touch">Status</th>
                        <th></th>
                     </tr>
                  </thead>
                  <tbody>
                     <template v-if="data_blokir.length !== 0">
                        <tr v-for="(d, i) in data_blokir" :key="i">
                           ...
                           <td class="is-hidden-touch">{{ d.STATUS }}</td>
                           <td>
...
export default {
   ...
   methods: {
      toXLSX: function() {
         const data = XLSX.utils.json_to_sheet(this.data_blokir)
         const wb = XLSX.utils.book_new()
         XLSX.utils.book_append_sheet(wb, data, 'data')
         XLSX.writeFile(wb,'blokir.xlsx')
      },
      refresh: function() {
         this.isLoading = true;
         setTimeout(() => {
